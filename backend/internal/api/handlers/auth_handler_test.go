...
import (
	...
	"github.com/nfsarch33/secure-auth-platform/backend/internal/mocks/service"
...
var _ = Describe("AuthHandler", func() {
	...
	Describe("SignUp", func() {
		It("should return 201 Created on successful signup", func() {
			...
			token := "mock-token"
			mockService.EXPECT().SignUp(gomock.Any(), reqBody.Email, reqBody.Password).
				Return(&models.User{Email: reqBody.Email, ID: uuid.New(), CreatedAt: time.Now()}, token, nil)
